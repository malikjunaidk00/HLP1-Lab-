...
try {
    ...
    cout << "Please enter expressions using floating numbers\n";
                                                                            //introducing which operators are available and how to use them
    cout << "HERE ARE SOME PREDEFINED OPERATORS TO BE USED AS:\n";
    cout << "addition is as '+'" << endl;
	cout << "subtraction is as '-'" << endl;
	cout << "multiplication is as '*'"<< endl;
	cout << "division is as '/'" << endl;
	cout << "start writing your expressions from here:";
	double val = 0;
